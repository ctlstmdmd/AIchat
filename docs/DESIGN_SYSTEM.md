...
The approved avatar and Channel assets are the active canonical artwork. `diary.webp` and `zone.webp` remain defensive fallbacks only; components must not hardcode a second character identity.
